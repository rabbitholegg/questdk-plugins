...
export const GMX_SWAPV2_ABI = [
  ...
  },
  {
    ...
    name: 'depositHandler',
    outputs: [
      { internalType: 'contract IDepositHandler', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'orderHandler',
    outputs: [
      { internalType: 'contract IOrderHandler', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'uiFeeFactor', type: 'uint256' }],
    name: 'setUiFeeFactor',
    outputs: [],
    stateMutability: 'payable',
    type: 'function',
