...
export const TETHER_OPTIMISM_ADDRESS = '0x94b008aA00579c1307B0EF2c499aD98a8ce58e58' // Only Tether has it's own address on Optimism
...
export const CHAIN_ID_TO_TOKENS: {[chainId: number]: readonly string[] } = {
  ...
  [OP_CHAIN_ID]: [ETH_TOKEN_ADDRESS, USDC_TOKEN_ADDRESS, TETHER_OPTIMISM_ADDRESS],
} as const
