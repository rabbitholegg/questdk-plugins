...
export const GMX = new Token({
  ...
  wrapperAddresses: {
    [43114]: '0x20A9DC684B4d0407EF8C9A302BEAaA18ee15F656',
  },
  decimals: 18,
  symbol: 'GMX',
  name: 'GMX',
...
export const UNIDX = new Token({
  addresses: {
    [1]: '0xf0655dcee37e5c0b70fffd70d85f88f8edf0aff6',
    [42161]: '0x5429706887FCb58a595677B73E9B0441C25d993D',
    [250]: '0x0483a76D80D0aFEC6bd2afd12C1AD865b9DF1471',
    [10]: '0x28b42698Caf46B4B012CF38b6C75867E0762186D',
    [8453]: '0x6B4712AE9797C199edd44F897cA09BC57628a1CF',
  },
  decimals: 18,
  symbol: 'UNIDX',
  name: 'Unidex',
...
export const USDC = new Token({
  ...
  swapableType: 'USD',
  swapableOn: [
    56, 1, 137, 42161, 43114, 1666600000, 1313161554, 288, 10, 1088, 25, 7700,
  ],
  color: 'blue',
  priorityRank: 1,
  routeSymbol: 'USDC',
...
export const USDT = new Token({
  ...
  color: 'lime',
  swapableType: 'USD',
  swapableOn: [56, 1, 137, 42161, 43114, 1666600000, 1313161554, 288, 7700],
  visibilityRank: 100,
  priorityRank: 1,
  routeSymbol: 'USDT',
})
...
export const DAI = new Token({
  ...
  name: 'Dai',
  swapableType: 'USD',
  swapableOn: [1, 137, 43114, 1666600000, 288],
  color: 'yellow',
  visibilityRank: 100,
  priorityRank: 1,
  routeSymbol: 'DAI',
...
export const SYNFRAX = new Token({
  addresses: {
    [250]: '0x1852F70512298d56e9c8FDd905e02581E04ddb2a',
...
export const NUSD = new Token({
  ...
  swapableType: 'USD',
  swapableOn: [
    56, 137, 250, 42161, 43114, 1666600000, 1313161554, 288, 10, 1088, 25, 7700,
  ],
  color: 'purple',
  visibilityRank: 50,
  priorityRank: 5,
...
export const NETH = new Token({
  ...
  name: 'Synapse nETH',
  swapableType: 'ETH',
  swapableOn: [10, 288, 1088, 7700, 8453, 42161, 43114, 1666600000],
  color: 'purple',
  visibilityRank: 50,
  priorityRank: 5,
  routeSymbol: 'nETH',
...
export const ETH = new Token({
  addresses: {
    ...
    [8453]: zeroAddress,
    [42161]: zeroAddress,
    [53935]: '0xfBDF0E31808d0aa7b9509AA6aBC9754E48C58852',
  },
  decimals: 18,
  symbol: 'ETH',
  name: 'Ethereum',
...
export const AVAX = new Token({
  addresses: {
    ...
    [8217]: '0xCd8fE44A29Db9159dB36f96570d7A4d91986f528',
    [43114]: zeroAddress,
    [53935]: '0xB57B60DeBDB0b8172bb6316a9164bd3C695F133a',
    [1666600000]: '0xb12c13e66AdE1F72f71834f2FC5082Db8C091358',
  },
  decimals: 18,
  symbol: 'AVAX',
  name: 'AVAX',
...
export const WJEWEL = new Token({
  addresses: {
    [53935]: '0xCCb93dABD71c8Dad03Fc4CE5559dC3D89F67a260',
  },
  decimals: 18,
  symbol: 'WJEWEL',
  name: 'Wrapped JEWEL',
...
export const WSOHM = new Token({
  addresses: {
    ...
    [42161]: '0x30bD4e574a15994B35EF9C7a5bc29002F1224821',
    [43114]: '0x240E332Cd26AaE10622B24160D23425A17256F5d',
  },
  decimals: {
    [1]: 18,
    [42161]: 18,
...
export const BTCB = new Token({
  addresses: {
    [8217]: '0xe82f87ba4E97b2796aA0Fa4eFB06e8f0d2EB4FE1',
    [43114]: '0x152b9d0FdC40C096757F570A51E494bd4b943E50',
    [53935]: '0x7516EB8B8Edfa420f540a162335eACF3ea05a247',
  },
  decimals: {
    [8217]: 8,
    [43114]: 8,
...
export const KLAY = new Token({
  addresses: {
    [8217]: zeroAddress,
    [53935]: '0x97855Ba65aa7ed2F65Ed832a776537268158B78a',
  },
  decimals: {
    [8217]: 18,
    [53935]: 18,
...
export const MATIC = new Token({
  addresses: {
    [137]: zeroAddress,
    [53935]: '0xD17a41Cd199edF1093A9Be4404EaDe52Ec19698e',
  },
  decimals: 18,
  symbol: 'MATIC',
  name: 'MATIC',
...
export const FTM = new Token({
  addresses: {
    [250]: zeroAddress,
    [53935]: '0x2Df041186C844F8a2e2b63F16145Bc6Ff7d23E25',
  },
  decimals: 18,
  symbol: 'FTM',
  name: 'Fantom',
...
export const WETH = new Token({
  addresses: {
    ...
    [10]: '0x121ab82b49B2BC4c7901CA46B8277962b4350204',
    [288]: '0xd203De32170130082896b4111eDF825a4774c18E',
