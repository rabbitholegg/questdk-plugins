...
export const passingTestCases = [
  ...
  createTestCase(MINT_BATCH_WITHOUT_FEES, 'using "any tokenId" on batchmint', { tokenId: undefined, amount: undefined }),
  createTestCase(MINT_WITH_REWARDS, 'using "any tokenId" on single mint', { tokenId: undefined, amount: undefined })
]
...
export const failingTestCases = [
  ...
  createTestCase(MINT_BATCH_WITHOUT_FEES, 'when using batchMint and contractAddress is incorrect', {
    contractAddress: '0x4f330940159fB3368F5b06b34212C0cDB4e2C032',
  }),
  createTestCase(MINT_BATCH_WITHOUT_FEES, 'when using batchMint and tokenId is incorrect', {
    tokenId: 10,
  }),
]
