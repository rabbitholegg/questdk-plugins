export default [
  ...
  {
    inputs: [],
    name: 'EndTimeLessThanOrEqualToStartTime',
    type: 'error',
  },
  {
    inputs: [],
    name: 'MustImplementInChild',
    type: 'error',
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: 'TotalAmountExceedsBalance',
    type: 'error',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract QuestFactory',
        name: '',
        type: 'address',
      },
    ],
